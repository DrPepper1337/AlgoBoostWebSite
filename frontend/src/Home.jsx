      ...
      <>
          ...
          <div className="square-wrapper">
            {!isMobile ? (
              <Tilt className="square" maxTilt={10} perspective={800}>
                <p>
                  Want to get better at coding challenges and ace that technical
                  interview? You are in the right place! We are here to help you
                  succeed through workshops, tutorials, mock interviews and
                  hackathons.
                </p>
              </Tilt>
            ) : (
              <div className="square-wrapper-mobile">
                {" "}
                <div className="square">
                  <p>
                    Want to get better at coding challenges and ace that
                    technical interview? You are in the right place!
                  </p>{" "}
                </div>
              </div>
            )}
        ...
        >
          <div
            ...
            data-sr="up"
            style={{ "--sr-order": 0, "--sr-dur": "2s" }}
          >
            <h1 className="reveal" data-sr="up" style={{ "--sr-order": 0 }}>
              Who we are
            </h1>
            <h3 className="reveal" data-sr="up" style={{ "--sr-order": 1 }}>
              And what we usually do
            </h3>
            <p className="reveal" data-sr="up" style={{ "--sr-order": 2 }}>
              AlgoBoost helps you master data structures and algorithms while
              preparing for technical interviews in a supportive and
              collaborative environment. From workshops and tutorials to mock
              interviews and hackathons, we make sure LeetCode is never boring
              again!
            </p>
          </div>
        ...
        <section id="footer" className="section">
          <div className="footer-links">
            ...
            <a href="https://www.instagram.com/algoboost_usta?igsh=MXFrYXFxNmRhbWhhMw%3D%3D&utm_source=qr">
              Instagram
            </a>
            <a href="https://www.linkedin.com/company/algoboost-society/?viewAsMember=true">
              LinkedIn
            </a>
            <a href="mailto:algoboost@st-andrews.ac.uk">
              algoboost@st-andrews.ac.uk
            </a>
          </div>
          <div className="footer-copyright">
            <p>
              &copy; 2025 St Andrews Algoboost Society. All Rights Reserved.
            </p>
          </div>
        </section>
      </>
